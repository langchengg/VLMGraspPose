...
def main() -> None:
    ...
    dataset_metric_csv = output_root / "metrics_by_dataset.csv"
    runtime_csv = output_root / "runtime_report.csv"
    if dataset_metric_csv.exists():
        shutil.copy2(dataset_metric_csv, figure_root / "table_dataset_results.csv")
