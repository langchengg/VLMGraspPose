"""Freeze the audited compatibility record for the completed feature plan."""
...
from d1_reranking.feature_source_adapter import (  # noqa: E402
    ADAPTER_RELATIVE,
...
def main() -> int:
    ...
    with ledger_stage(
        ...
        stage="P13",
        substage="d1_feature_source_adapter_v1",
        route="D1",
        evidence_track="raw_matched_common",
        method="authorization_tool_postexecution_adapter",
        command=" ".join(map(str, sys.argv)),
    ) as state:
        value = prepare_feature_source_adapter(root, resume=args.resume)
